...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    JTextField tfcource, tfaddress, tfphone, tfemail, tfbranch;
    JLabel labelrollno;
    ...
    public UpdateStudent(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                tfcource.setText(rs.getString("cource"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){           
            ...
            try{
                String query = "update student set address = '"+address+"', phone= '"+phone+"',email= '"+email+"',cource= '"+cource+"',branch= '"+branch+"' where rollno='"+rollno+"'";
